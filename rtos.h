...
/* GPIO Trace for Logic Analyzer */
void gpio_trace_high(uint32_t pin);
void gpio_trace_low(uint32_t pin);

#define PIN_TASK1     (1UL << 0)
#define PIN_TASK2     (1UL << 1)
#define PIN_IDLE      (1UL << 4)
#define PIN_TICK      (1UL << 5)
